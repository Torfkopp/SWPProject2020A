...
public class SceneManagerProvider {
     ...
     */
    @Provides
    public SceneManager provideSceneManager(ISoundService soundService, EventBus eventBus,
                                            @Assisted Stage primaryStage) {
        if (sceneManager == null) {
            this.sceneManager = new SceneManager(soundService, eventBus, primaryStage);
        }
