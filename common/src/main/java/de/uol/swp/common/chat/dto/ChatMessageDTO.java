...
public class ChatMessageDTO implements ChatMessage {
     ...
     */
    public ChatMessageDTO(int id, Actor author, Instant timestamp, String content) {
     ...
     * @param content The content of the message
     */
    public ChatMessageDTO(int id, Actor author, String content) {
     ...
     */
    public ChatMessageDTO(int id, Actor author, Instant timestamp, String content, boolean edited) {
