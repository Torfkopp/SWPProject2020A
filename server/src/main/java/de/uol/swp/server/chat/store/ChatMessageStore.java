...
public interface ChatMessageStore {
    ...
    /**
     * Method to retrieve a ChatMessage from the global Chat Store through its ID
     *
    ...
    /**
     * Method to retrieve a ChatMessage from a Lobby's Chat Store through its ID
     *
     * @param id          The ID to look up
    ...
    /**
     * Method to create a ChatMessage in a Lobby's Chat Store
     *
     * @param author      The User who wrote the ChatMessage
     * @param content     The content of the message
