...
class UserServiceTest {
    ...
    void userServiceTest() {
        ...
        final Message changeAccountDetailsRequest = new UpdateUserAccountDetailsRequest(newUser,
                                                                                        user.getPassword(),
                                                                                        user.getUsername(),
                                                                                        user.getEMail());
        ...
        // Test deletion
        final Message deletionRequest = new DeleteUserRequest(changedUser.get());
