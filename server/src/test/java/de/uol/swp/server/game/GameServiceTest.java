...
//        game.setDiceRolledAlready(true);
//        bus.post(new PlayMonopolyCardRequest(lobby.getName(), user[0], ResourceTypeBRICK));
...
//        game.setDiceRolledAlready(true);
//        bus.post(new PlayYearOfPlentyCardRequest(lobby.getName(), user[0], ResourceTypeBRICK, ResourceTypeGRAIN));
...
//        map.put(ResourceTypeORE, 1);
//        map.put(ResourceTypeGRAIN, 2);
//        map.put(ResourceTypeWOOL, 2);
...
//        assertEquals(5, gameInventory[0].getLumber());
//        game.setDiceRolledAlready(true);
//        Message executeTradeWithBankRequest = new ExecuteTradeWithBankRequest(user[0], "testlobby", ResourceTypeWOOL,
//                                                                              ResourceTypeBRICK);
//
...
//        brickMap.put("enumType", ResourceTypeBRICK);
...
//        oreMap.put("enumType", ResourceTypeORE);
//        offeredResourceList.add(oreMap);
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeGRAIN));
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeLUMBER));
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeWOOL));
...
//        woolMap.put("enumType", ResourceTypeWOOL);
...
//        lumberMap.put("enumType", ResourceTypeLUMBER);
//        demandedResourceList.add(lumberMap);
//        demandedResourceList.add(getEmptyResourceMap(ResourceTypeBRICK));
//        demandedResourceList.add(getEmptyResourceMap(ResourceTypeGRAIN));
//        demandedResourceList.add(getEmptyResourceMap(ResourceTypeORE));
//        game.setDiceRolledAlready(true);
...
//        Map<String, Object> brickMap = new HashMap<>();
//        brickMap.put("amount", 2);
//        brickMap.put("resource", ResourceTypeBRICK);
//        offeredResourceList.add(brickMap);
//        Map<String, Object> oreMap = new HashMap<>();
//        oreMap.put("amount", 3);
//        oreMap.put("resource", ResourceTypeORE);
//        offeredResourceList.add(oreMap);
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeGRAIN));
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeLUMBER));
//        offeredResourceList.add(getEmptyResourceMap(ResourceTypeWOOL));
...
//        Map<String, Object> woolMap = new HashMap<>();
//        woolMap.put("amount", 1);
//        woolMap.put("resource", ResourceTypeWOOL);
//        demandedResourceList.add(woolMap);
//        Map<String, Object> lumberMap = new HashMap<>();
//        lumberMap.put("amount", 4);
//        lumberMap.put("resource", ResourceTypeLUMBER);
//        demandedResourceList.add(lumberMap);
//        demandedResourceList.add(getEmptyResourceMap(ResourceTypeBRICK));
//        demandedResourceList.add(getEmptyResourceMap(ResourceTypeGRAIN));
//        demandedResourceList.add(getEmptyResourceMap(ResourceType.ORE));
//
